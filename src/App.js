...
import './App.css';
import FormCheck from './Component/FormCheck.js';
import Quest from './Component/Quest.js';
  ...
  render() {
    ...
    return (
      ...
      <div className="_bailuan">
        <Menu/>
        <Nav appSubmitSignIn={(name, pass) => this.submitSignIn(name, pass)} />
        <div>
          <About />
          ...
          <div className="card-footer text-xs-center" >
            <div className="masthead">
              <button data-toggle="modal" type="button" data-target="#myModal" className="btn btn-primary btn-block btn-sm" onClick={() => this.ClickVote()} >
